...
function loadPlaces(map, lat, lng) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/v1/stores/near?lat=".concat(lat, "&lng=").concat(lng)).then(function (res) {
    var places = res.data;
...
function makeMap(mapDiv) {
  ...
  navigator.geolocation.getCurrentPosition(function (data) {
    ...
    var autocomplete = new google.maps.places.Autocomplete(input); // console.log(`lat is ${lat},long is ${lng}`);
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/v1/search?q=".concat(this.value)).then(function (res) {
      ...
      searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default.a.sanitize("<div class=\"search__result\">No results for <strong>".concat(_this.value, "</strong> found!</div>"));
    }).catch(function (err) {
      //Look up sentry for front end error tracking logs
      console.error(err);
    });
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./style.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./public/sass/style.scss");
